...
class UsuarioAdapter2 : RecyclerView.Adapter<UsuarioAdapter2.UsuarioViewHolder>() {
    ...
    override fun onBindViewHolder(holder: UsuarioViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener{
            ...
            it.findNavController().navigate(R.id.action_adminPanelFragment_to_childDetailsFragment,bundle)
        }
    }
